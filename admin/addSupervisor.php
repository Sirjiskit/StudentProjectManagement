...
<html lang="en">
<head>
    <title>Projects Management :: Admin Add Supervisor</title>
    ...
    <body>
       <!-- Include Top here-->
        ...
        <div id="body-container">
            <div id="body-content">
                ...
                <?php include('nav.php'); ?>
                <!-- Content goes here -->
       <section class="nav nav-page"  pageVTourUrl="guide/tour/form-tour.html" pageVGuideUrl="guide/form-guide.html">
        <div class="container">
            <div class="row">
                <div class="span7">
                    <header class="page-header">
                        <h3><i class="icon-edit"></i>New Supervisor<br><small> add new supervisor</small>
                        </h3>
                    </header>
                </div>
                 <div class="span9">
     ...
     <section id="my-account-security-form" class="page container">
            <form id="userSecurityForm" class="form-horizontal" action="addSupervisor" method="post">
                <div class="container">
                    ...
                    <div class="alert alert-block alert-info">
                        <p>
                            Enter the information of the supervisor.  Fields marked with an asterisk
                            are required.
                        </p>
                    </div>
                    <div class="row">
                     <div>
                        <div id="new-saff-info-row" class="span7">
                        <fieldset>
                        <legend>Supervisor Information</legend>
                        
                                <div class="control-group ">
                                    <label class="control-label">Staff ID: <span class="required">*</span></label>
                                    <div class="controls">
                                        <input id="staffid-control" name="staffid" class="span4" type="text" value="" autocomplete="false" required='' pattern="^((FPB/)?(S/P/)?\d{3})+$" placeholder="e.g FPB/S/P/001" title="e.g FPB/S/P/001">
		...
		$(document).ready(function(){
			$('#li-staff').parent('li').addClass("active");
			...
			$('#userSecurityForm').submit(function(e){
				...
				//var dataForm = $(this).serialize();
				 $.confirm({
                            title: 'Confirmation',
                            content: 'Are you sure you want to add this supervisor',
                                    ...
                                    action: function () {
                                        ...
                                        $.confirm({
											...
											content: function () {
												var self = this;
												return $.ajax({
													url: 'api/api.process?AddSuppervisor',
													dataType: 'json',
													method: 'get',
													data:formData
												}).done(function (rs) {
													if(rs.s==1){$('#userSecurityForm').trigger('reset');}
