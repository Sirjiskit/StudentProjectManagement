...
if (strlen($_SESSION['login']) == 0) {
    ...
    $query8 = mysqli_query($con, "Select * from  tblusers");
    $student = 0;
    $staff = 0;
    while ($row = mysqli_fetch_array($query8)) {
        if (getUserType($row['email']) == 1):
            $student++;
        else:
            $staff++;
        endif;
                    ...
                    <div class="content">
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <a href="manage-subcategories.php" class="text-white">
                                    <div class="col-lg-4 col-md-4 col-sm-6">
                                ...
                                <a href="manage-posts.php" class="text-white">                       
                                    <div class="col-lg-4 col-md-4 col-sm-6">
                                        <div class="card-box widget-box-one bg-purple">
                            ...
                            <div class="row">
                                ...
                                <a href="trash-posts.php" class="text-white"> 
                                    <div class="col-lg-4 col-md-4 col-sm-6">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6">
                                        <div class="card-box widget-box-one bg-success">
                                            ...
                                            <div class="wigdet-one-content">
                                                ...
                                                <h2><?php echo htmlentities($student); ?> <small></small></h2>
                                ...
                                <a href="users.php" class="text-white"> 
                                    <div class="col-lg-4 col-md-4 col-sm-6">
                                        <div class="card-box widget-box-one bg-info">
                                            <i class="mdi mdi-account-multiple widget-one-icon"></i>
                                            <div class="wigdet-one-content">
                                                <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">Staff</p>
                                                
                                                <h2><?php echo htmlentities($staff); ?> <small></small></h2>
