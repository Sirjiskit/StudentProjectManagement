                                        ...
                                        <div class="demo-box m-t-20">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $query = mysqli_query($con, "Select c.id,  u.fullname,c.postingDate,c.comment,p.id as postid,p.PostTitle,c.status "
                                                                . "from  tblcomments c join tblposts p on p.id=c.postId left join tblusers u on c.userid=u.userid where c.status=1");
                                                        $cnt = 1;
                                                        while ($row = mysqli_fetch_array($query)) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo empty(htmlentities($row['fullname'])) ? 'Anonynous' : htmlentities($row['fullname']); ?></td>
