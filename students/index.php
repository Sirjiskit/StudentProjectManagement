            ...
            <div class="span8">
                <div class="box pattern pattern-sandstone">
                    ...
                    <div class="box-content box-list collapse in box-list1">
                        <ul>
                        <?php 
						$sql = $data->query("SELECT * FROM `notifications` where type=2 and receiverid=$id and status=0 
            ...
            <div class="span8">
                <div class="blockoff-left">
                    ...
                    <div class="box pattern pattern-sandstone">
                        ...
                        <ul class="myInfo">
                        <?php $sql = $data->query($data->StudentList($id));
							$row = $data->fetch_assoc($sql);
						?>
                        <li><span>Reg. No:</span><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row['studentid'] ?></span></li>
                        ...
                        <li><span>Supervisor:</span><span>&nbsp;&nbsp;&nbsp;
						<?php echo $data->getSupervisor($data->getSupAssignedStudents($row['id'])); ?></span></li>
                        <li><span>Topic:</span><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                        <?php echo $data->getApprovedTopic($row['id']) ?></span></li>
                        </ul>
                        </div>
                    </div>
                </div>
